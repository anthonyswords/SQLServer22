...
<body>
    <form method="post" action="./OpenDocument?id=151" id="form1">
<div class="aspNetHidden">
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="u4peN8DAj0nJA5TwQKeFmQznNVV4Uia3s1n6F98cUIPmta/GrmY4M+tI+zXGKc9y1UABtlRG7gLGFMqxu+7T9ANWiH4=" />
</div>

<div class="aspNetHidden">

	<input type="hidden" name="__VIEWSTATEGENERATOR" id="__VIEWSTATEGENERATOR" value="3B718233" />
</div>
        <div>
        </div>
    </form>
